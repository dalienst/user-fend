    ...
    return ( 
        <div className="split-screen">
            <div style={{backgroundImage: "url('" + props.img + "')" }} className="left">
                <Link to="/" className="logo logo-split-screen">elephant room</Link> 
            </div>
            <div className="right">
                <div className="logo-container"><Link to="/" className="logo logo-split-screen logo-mobile">elephant room</Link></div> 
